...
TASK-536 で新設したブックマーク管理パネル（Bookmarks > ブックマークを編集…、`BookmarkManagerView`）を実際に使ったところ、次の 5 点で使いにくいことが分かった。
...
4. パネルを開くキーボードショートカットが無い（TASK-536.1 で「キー等価は付けない」と判断していた）
