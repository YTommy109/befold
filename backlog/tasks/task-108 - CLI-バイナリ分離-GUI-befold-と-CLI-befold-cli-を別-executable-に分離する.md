...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 befold-cli executable が Package.swift に定義され swift build でビルドできる
- [ ] #2 befold-cli は NSApplication.run() を一切呼ばず、GUI 化しない
- [ ] #3 befold (GUI) の AppDelegate から CLI 分岐ロジックが除去されている
- [ ] #4 CLIInstaller の symlink 先が Contents/MacOS/befold-cli に変更されている
