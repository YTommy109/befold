...
public enum TextEncoding: Sendable {
    ...
    public static func detectEncoding(_ data: Data) -> String.Encoding? {
        ...
        if data.prefix(sniffLength).contains(0) {
            return looksLittleEndianUTF16(data) ? .utf16LittleEndian : .utf16BigEndian
        }
    ...
    /// エンコーディング判定は detectEncoding に委譲し、BOM の剥がしのみここで行う。
    ...
    public static func decodeText(_ data: Data) -> String? {
        ...
        guard let encoding = detectEncoding(data) else { return nil }
